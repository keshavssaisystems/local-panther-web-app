        ...
        <Nav className="header-megamenu">
          <NavItem>
            <NavLink href="#" onClick={this.toggle} id="PopoverMegaMenuFooter">
              Footer Menu
              <FontAwesomeIcon className="mr-2 opacity-8" icon={faAngleUp} />
            </NavLink>
          </NavItem>
          <Popover className="rm-max-width" placement="top-start" fade={false} hideArrow trigger="legacy"
            isOpen={this.state.popoverOpen} target="PopoverMegaMenuFooter" toggle={this.toggle}>
          ...
          <Popover className="rm-max-width popover-custom" fade={false} hideArrow trigger="legacy" placement="top-start"
            isOpen={this.state.popoverOpen2} target="PopoverGridFooter" toggle={this.toggle2}>
            ...
            <Nav vertical>
              ...
              <NavItem className="nav-item-btn clearfix">
                <div className="float-left">
                  <Button size="sm" color="link"> Link Button </Button>
                </div>
                <div className="float-right">
                  <Button size="sm" className="btn-shadow" color="info"> Info Button </Button>
                </div>
              </NavItem>
            </Nav>
          </Popover>
