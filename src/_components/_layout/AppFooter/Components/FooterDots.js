    ...
    return (
      <Fragment>
        <div className="footer-dots">
          ...
          <Popover className="popover-custom popover-custom-xl" container=".app-container"
            hideArrow fade={false} trigger="legacy" placement="top"
            isOpen={this.state.popoverOpen1} target="PopoverFooter-1" toggle={this.toggle1}>
            ...
            <div className="card-tabs-animated card-tabs-animated-inner">
              <Tabs tabsWrapperClass="body-tabs body-tabs-alt" transform={false} items={getTabs()}/>
            </div>
            <Nav vertical>
          ...
          <Popover className="popover-custom popover-custom-sm" trigger="legacy"  hideArrow fade={false} placement="top"
            isOpen={this.state.popoverOpen2} target="PopoverFooter-2" toggle={this.toggle2}>
            ...
            <div className="dropdown-menu-rounded">
              ...
              <DropdownItem active>
                <Flag className="ml-3 opacity-8" country="DE" />
                Germany
              </DropdownItem>
              <DropdownItem divider />
              <DropdownItem header>Popular Languages</DropdownItem>
              <DropdownItem>
                <Flag className="ml-3 opacity-8" country="US" />
                USA
              </DropdownItem>
              <DropdownItem>
                <Flag className="ml-3 opacity-8" country="CH" />
                Switzerland
              </DropdownItem>
              <DropdownItem>
                <Flag className="ml-3 opacity-8" country="FR" />
                France
              </DropdownItem>
              <DropdownItem>
                <Flag className="ml-3 opacity-8" country="ES" />
                Spain
              </DropdownItem>
            </div>
          </Popover>
          <Popover className="popover-custom popover-custom-lg" fade={false} hideArrow trigger="legacy" placement="top"
            isOpen={this.state.popoverOpen3} target="PopoverFooter-3" toggle={this.toggle3}>
            <div className="dropdown-menu-header">
              <div className="dropdown-menu-header-inner bg-malibu-beach">
                ...
                <div className="menu-header-content text-white">
                  ...
                  <h6 className="menu-header-subtitle"> Just an example of a slider with some chart widgets inside. </h6>
                </div>
              </div>
            </div>
                        ...
                        <div className="widget-numbers">
                          <div className="widget-chart-flex">
                            <div>
                              ...
                              <CountUp start={10} end={78} separator="" decimals={0} decimal="" prefix="" duration="10"/>
                        ...
                        <ResponsiveContainer height="100%">
                          <AreaChart data={data55}
                            ...
                            <Area type="monotoneX" dataKey="uv" stroke="var(--success)"
                              strokeWidth="4" fill="var(--success)" fillOpacity=".1"/>
                          </AreaChart>
                        </ResponsiveContainer>
                      </div>
                    </div>
