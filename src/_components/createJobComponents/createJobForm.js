...
export default function CreateJob({
  ...
  const saveData = (eventData) => {
    ...
    let workSchedule = getWorkSchedule(eventData.target.elements.workSchedule);
    ...
    let paymentBenifits = {
      ...
      compensationPackage: eventData.target.elements.compensationPackage.value,
    ...
    let niceToHave = getStringData(eventData.target.elements.niceToHave, false);
    if (
  ...
  return (
    <>
      <div className="form-wizard-content">
        <Form onSubmit={(e) => getFormValidation(e)} id="myForm">
                            ...
                            <Input
                              ...
                              defaultChecked={
                                type === "new_template" && previousStep !== 3
                                  ...
                                  : previousValue.sponsorshiprequiured === true
                              }
                              value={"yes"}
