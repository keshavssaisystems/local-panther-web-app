...
export default function PublishJobStep({
  ...
  useEffect(() => {
    let main = {
      ...
      cityid: reqData.basicInformation.cityId ? Number(reqData.basicInformation.cityId) : 0,
      stateid: reqData.basicInformation.stateId ? Number(reqData.basicInformation.stateId) : 0,
