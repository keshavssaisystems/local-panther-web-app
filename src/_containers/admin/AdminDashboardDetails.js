...
import {
  ...
  getScores,
} from "_containers/admin/_redux/adminDashboard.slice";
          ...
          <div className="widget-chat-wrapper-outer">
            <div className="widget-chart-content">
              <div className="widget-content-left fsize-1">
                <div className="text-muted opacity-6">{ele.title}</div>
              </div>
  ...
  return (
    <Fragment>
      <TransitionGroup>
        <CSSTransition
          component="div"
          classNames="admin-dashboard-details TabsAnimation "
          appear={true}
          timeout={1500}
          enter={false}
          exit={false}
            ...
            <Card className="mb-3">
                ...
                <Nav justified>
                  <NavItem>
                    ...
                    >
                      <div className="widget-number">
                        <CountUp
                          start={0}
                          end={dashboardCountDetails?.activecandidatecount || 0}
                          separator=","
                          decimals={0}
                          decimal=""
                          delay={2}
                      ...
                      <div className="tab-subheading fsize-1 fw-normal">
                        <i className="header-icon lnr-users me-3 text-muted opacity-6">
                          {" "}
                        </i>
                        Candidates
                      </div>
                  ...
                  <NavItem>
                    ...
                    >
                      <div className="widget-number ">
                        ...
                        <CountUp
                          start={0}
                          end={dashboardCountDetails?.openjobcount || 0}
                          separator=""
                          decimals={0}
                          decimal=""
                          delay={2}
                      ...
                      <div className="tab-subheading fsize-1 fw-normal">
                        <i className="header-icon lnr-graduation-hat me-3 text-muted opacity-6">
                          {" "}
                        </i>
                        Jobs
                      </div>
                  ...
                  <NavItem>
                    ...
                    >
                      <div className="widget-number text-danger">
                        <CountUp
                          start={0}
                            ...
                            dashboardCountDetails?.todaysinterviewscheduledcount ||
                            0
                          }
                          separator=","
                          decimals={0}
                      ...
                      <div className="tab-subheading fsize-1 fw-normal">
                        <i className="header-icon lnr-calendar-full me-3 text-muted opacity-6">
                          {" "}
                        </i>
                        Interviews
                      </div>
              ...
              <TabContent activeTab={activeTab}>
                ...
                <TabPane tabId="2">
                  ...
                  <CardBody>
                    <Chart
                      options={initialState.optionsJobsChart}
                      series={initialState.seriesJobsChart}
                      type="line"
                      width="100%"
                      height="330px"
                    />
                ...
                <TabPane tabId="3">
                  ...
                  <CardBody>
                    <Chart
                      options={initialState.optionsInterviewChart}
                      series={initialState.seriesInterviewChart}
                      type="line"
                      width="100%"
                      height="330px"
                    />
