...
const CustomerReportScheduledInterviews = React.lazy(() => import("_containers/customer/reports/customerscheduleinterviews").then(m => ({ default: m.CustomerReportScheduledInterviews }))
);
const CustomerReportInterviewedCandidates = React.lazy(() => import("_containers/customer/reports/customerinterviewdcandidates").then(m => ({ default: m.CustomerReportInterviewedCandidates }))
);
const CustomerReportJobAging = React.lazy(() => import("_containers/customer/reports/customerjobaging").then(m => ({ default: m.CustomerReportJobAging }))
);
const CustomerReportMatchedCandidate = React.lazy(() => import("_containers/customer/reports/customermatchedjoblist").then(m => ({ default: m.CustomerReportMatchedCandidate }))
);
const CustomerReportCandidateStatus = React.lazy(() => import("_containers/customer/reports/customercandidatestatuslist").then(m => ({ default: m.CustomerReportCandidateStatus }))
);
...
const CustomerList = React.lazy(() =>
  import("_containers/admin/customer/customerList").then(m => ({ default: m.CustomerList }))
);
...
const Skills = React.lazy(() =>
  import("_containers/admin/masters/skills").then(m => ({ default: m.Skills }))
);
const FlaggedWord = React.lazy(() => import("_containers/admin/masters/flaggedWords").then(m => ({ default: m.FlaggedWord })));
const SubsidaryList = React.lazy(() =>
  import("_containers/admin/masters/subsidary").then(m => ({ default: m.SubsidaryList }))
);

const CompanyList = React.lazy(() =>
  import("_containers/admin/company/companyList").then(m => ({ default: m.CompanyList }))
);

const AdminCalendar = React.lazy(() =>
  import("_containers/admin").then(m => ({ default: m.AdminCalendar }))
);
...
const HiringManager = React.lazy(() => import("_containers/admin").then(m => ({ default: m.HiringManager })));
const CandidateReport = React.lazy(() => import("_containers/admin").then(m => ({ default: m.CandidateReport })));
const IncompleteCandidateProfile = React.lazy(() => import("_containers/admin").then(m => ({ default: m.IncompleteCandidateProfile })));
const JobsWithoutMatchedCandidates = React.lazy(() => import("_containers/admin").then(m => ({ default: m.JobsWithoutMatchedCandidates })));
const CandidateWithoutMatchedJobs = React.lazy(() => import("_containers/admin").then(m => ({ default: m.CandidateWithoutMatchedJobs })));
const NonPublishedJobs = React.lazy(() => import("_containers/admin").then(m => ({ default: m.NonPublishedJobs })));
const BullhornCandidate = React.lazy(() => import("_containers/admin/reports/bullhornCandidate").then(m => ({ default: m.BullhornCandidate })));

const ATSCandidate = React.lazy(() => import("_containers/admin/reports/ATSCandidateReport").then(m => ({ default: m.ATSCandidate })));
const CandidateInterviewFeedback = React.lazy(() =>
  import("_containers/customer/reports/candidateinterviewfeedback").then(m => ({ default: m.CandidateInterviewFeedback }))
);
    ...
    return (
      <>
        ...
        <Route
          ...
          element={
            <PrivateRoute>
              <ATSGenericList isCompanyAdmin={true} entity="atsgeneric" />
            </PrivateRoute>
          }
        />
        <Route
          path="/ats/atsassignee"
          element={
            <PrivateRoute>
              <ATSGenericList isCompanyAdmin={true} entity="atsgeneric" />
            </PrivateRoute>
