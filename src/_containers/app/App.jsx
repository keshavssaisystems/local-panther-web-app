...
import CustomerCandidateList from "_containers/customer/atscustomercandidatelist/cutomercandidatelist";
        ...
        <>
          ...
          />
           <Route
            ...
            element={
              <PrivateRoute>
                <CustomerCandidateList isCompanyAdmin={true} entity="candidates" />
              </PrivateRoute>
            }
          />
        </>
