...
import { Row, Col, ListGroupItem, ListGroup, Button, CardTitle, CustomInput } from "reactstrap";
...
import { faTrashAlt, faCheck, faFilePdf, faFileExcel,
  faFileArchive, faFileAlt, faCloudDownloadAlt, } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="drawer-section">
          ...
          <div className="mt-3">
            ...
            <div className="text-center mt-2 d-block">
              <Button outline className="mr-2 border-0 btn-transition" color="danger"> Escalate Issue </Button>
          ...
          <div className="files-box">
            <ListGroup flush>
              <ListGroupItem className="pt-2 pb-2 pr-2">
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    <div className="widget-content-left opacity-6 fsize-2 ml-3 text-primary center-elem">
              ...
              <ListGroupItem className="pt-2 pb-2 pr-2">
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    <div className="widget-content-left opacity-6 fsize-2 ml-3 text-warning center-elem">
              ...
              <ListGroupItem className="pt-2 pb-2 pr-2">
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    <div className="widget-content-left opacity-6 fsize-2 ml-3 text-danger center-elem">
              ...
              <ListGroupItem className="pt-2 pb-2 pr-2">
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    <div className="widget-content-left opacity-6 fsize-2 ml-3 text-success center-elem">
                  ...
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-left">
                      <div className="widget-heading">
                        Wash the car
                        <div className="badge badge-danger mr-2">Rejected</div>
                      </div>
              ...
              <ListGroupItem>
                ...
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-right mr-3">
                ...
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-right">
                      <div className="badge badge-warning ml-2">69</div>
                    </div>
                    <div className="widget-content-right">
                      <Button className="border-0 btn-transition" outline color="success">
                        <FontAwesomeIcon icon={faCheck} />
            ...
            <VerticalTimeline animate={false} layout="1-column" className="vertical-time-simple vertical-without-time">
              ...
              <VerticalTimelineElement className="vertical-timeline-item dot-success">
                <h4 className="timeline-title">
                  ...
                  <div className="badge badge-danger mr-2">NEW</div>
                </h4>
              </VerticalTimelineElement>
