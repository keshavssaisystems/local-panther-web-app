      ...
      <Fragment>
        <div className="header-dots">
          <UncontrolledDropdown>
            <DropdownToggle className="p-0 ml-2" color="link">
            ...
            <DropdownMenu right className="dropdown-menu-xl rm-pointers">
              ...
              <Nav vertical>
                ...
                <NavItem className="nav-item-btn text-center">
                  <Button size="sm" className="btn-shadow" color="primary"> Follow-ups </Button>
                </NavItem>
              </Nav>
            </DropdownMenu>
          </UncontrolledDropdown>
          <UncontrolledDropdown>
            ...
            <DropdownMenu right className="dropdown-menu-xl rm-pointers">
              ...
              <Nav vertical>
                <NavItem className="nav-item-divider" />
                <NavItem className="nav-item-btn text-center">
                  <Button size="sm" className="btn-shadow btn-wide btn-pill" color="focus"> View Latest Changes </Button>
                </NavItem>
              </Nav>
            </DropdownMenu>
          </UncontrolledDropdown>
          <UncontrolledDropdown>
            <DropdownToggle className="p-0 ml-2" color="link">
              <div className="icon-wrapper icon-wrapper-alt rounded-circle">
                ...
                <div className="language-icon">
                  <Flag className="ml-3 opacity-8" country="DE" size="40" />
                </div>
              </div>
            </DropdownToggle>
            <DropdownMenu right className="rm-pointers">
              ...
              <DropdownItem>
                <Flag className="ml-3 opacity-8" country="IT" />
                Italy
              </DropdownItem>
            </DropdownMenu>
          </UncontrolledDropdown>
              ...
              <Nav vertical>
                ...
                <NavItem className="nav-item-btn text-center">
                  <Button size="sm" className="btn-shine btn-wide btn-pill" color="warning">
                    <FontAwesomeIcon className="mr-2" icon={faCog} spin fixedWidth={false}/> Refresh List
                  </Button>
                </NavItem>
              </Nav>
            </DropdownMenu>
