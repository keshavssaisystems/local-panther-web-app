...
import { UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem, Popover, Nav,
  NavLink, Col, Row, NavItem, UncontrolledButtonDropdown,  Button, } from "reactstrap";
        ...
        <Nav className="header-megamenu">
          <NavItem>
            <NavLink href="#" onClick={this.toggle} id="PopoverMegaMenu">
              ...
              Mega Menu
              <FontAwesomeIcon className="mr-2 opacity-5" icon={faAngleDown} />
            </NavLink>
          </NavItem>
          ...
          <UncontrolledButtonDropdown nav inNavbar>
            <DropdownToggle nav>
              <div className="badge badge-pill badge-danger mr-0 ml-2">4</div>
              Settings
              <FontAwesomeIcon className="mr-2 opacity-5" icon={faAngleDown} />
            </DropdownToggle>
            <DropdownMenu className="rm-pointers">
              ...
              <Nav vertical>
                ...
                <NavItem className="nav-item-btn">
                  <Button size="sm" className="btn-wide btn-shadow" color="danger"> Cancel </Button>
                </NavItem>
              </Nav>
            </DropdownMenu>
                ...
                <div className="dropdown-menu-header-inner bg-success">
                  ...
                  <div className="menu-header-content text-left">
                    ...
                    <div className="menu-header-btn-pane">
                      <Button size="sm" color="dark" className="ml-2"> Settings </Button>
