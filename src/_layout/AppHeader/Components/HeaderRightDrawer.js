...
class HeaderRightDrawer extends React.Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <Drawer left className="drawer-content-wrapper p-0" width={450} open={openLeft}
          onChange={(open) => this.setState({ openLeft: open })} noTouchOpen={false} noTouchClose={false}>
          <PerfectScrollbar>
